    ...
    public function mount()
    {
        ...
        if ($userBio) {
            ...
            if($authorityDistrict == Null){
                $authorityDistrict = RegisteringAuthorityDistrict::withTrashed()->where('district_id', $userBio->district_id)->value('registering_authority_id');

                $this->signature = RegisteringAuthority::withTrashed()->where('id', $authorityDistrict)->first();
            }
        }
    }
