...
class TotalRegistration extends Component
{
    ...
    // {
    //     info('hydrate: '.$this->buttonEnable);
    // }
    ...
    public function generateCastReport($society)
    {
        ...
        // $maxQualificationId = EducationQualification::max('qualification_id');

        // $qualifications = Qualification::where('id', $maxQualificationId)->get();
    ...
    {
        return view('livewire.admin.reports.total-registration');
    }
}
