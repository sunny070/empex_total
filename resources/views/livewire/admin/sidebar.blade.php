<div class="mt-4"
    ...
    <div class="flex justify-center md:max-w-7xl md:mx-auto md:px-4">
        <div class="container">
            <div class="flex">
                <div
                    class="flex flex-col w-full py-1 font-sans text-left md:border-b-4 border-empex-yellow sm:flex-row sm:text-left sm:items-baseline">
                    ...
                    <x-jet-dropdown align="left">
                        <x-slot name="trigger">
                            <button
                                ...
                                <svg class="float-right w-4 h-4 fill-current" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20">
                                    <path
                    ...
                    {{-- added by sunny --}}
                    <x-jet-nav-link href="{{ Route('jobsPostNcs') }}" :active="request()->is('admin/employee-news-Ncs')"
                    ...
                    <x-jet-nav-link href="{{ Route('admin.controls.address') }}"
                        :active="request()->is('admin/admin-controls*')" class="hidden p-2 md:ml-4 md:flex">Admin
                    ...
                    <x-jet-dropdown align="left">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ Route('admin.controls.statement') }}"
                                class="{{ request()->is('admin/admin-controls/statement') ? 'active' : '' }}">
                                Payment Statement
                            </x-jet-dropdown-link>
                        </x-slot>
                    </x-jet-dropdown>
