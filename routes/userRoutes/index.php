...
Route::get('/employment-newsNcs/{JobTitle}', [NcsJobPostController::class, 'detail']);
...
Route::group(['prefix' => 'auth', 'middleware' => 'auth'], function () {
    ...
    Route::get('/employee/pdf-payment-receipt-a4', [PdfController::class, 'downloadPayment'])->name('auth.employee-payment-receipt.pdf.a4');
