...
Route::get('/employment-card', [DigilockerController::class, 'index']);
Route::get('/doc-employment-card', [DigilockerController::class, 'document']);


//NCS added by sunny
Route::group(['middleware' => 'auth:sanctum'], function(){
  //All secure URL's
  // Route::apiResource('job-posts-ncs', NcsJobPostController::class);
  Route::post('/job-posts-ncs/store', [NcsJobPostController::class,'store']);
  Route::get('/job-posts-ncs/get', [NcsJobPostController::class,'index']);
  Route::put('/job-posts-ncs/Update/{id}', [NcsJobPostController::class,'update']);
  Route::delete('/job-posts-ncs/delete/{job_reference_id}', [NcsJobPostController::class,'destroy']);
});

// Route::get('ncs',[NcsJobPostController::class,'show']);
Route::post("login-ncs",[NcsJobPostController::class,'login']);