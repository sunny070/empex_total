...
Route::middleware(['auth:admin', 'verified'])->prefix('admin')->group(function () {
    ...
    // addednew
    // Route::get('/employee-news-Ncs', [NcsJobDispatchController::class, 'getJobsPostNcs'])->name('jobsPostNcs');
    // Route::get('/employee-news/create-news-ncs', [NcsJobDispatchController::class, 'createJobsPostNcs'])->name('create.jobs.post.Ncs');
    Route::get('/employee-news-Ncs', [NCSStagingJobPostController::class, 'getJobsPostNcs'])->name('jobsPostNcs');
    Route::get('/employee-news-Ncs/create-news-ncs', [NCSStagingJobPostController::class, 'createJobsPostNcs'])->name('create.jobs.post.Ncs');
    Route::get('/employee-news-Ncs/{id}/editNcs', [NCSStagingJobPostController::class, 'editJobNcs'])->name('edit.job.ncs');
    Route::post('/employee-news-Ncs/{id}/updateNcs', [NCSStagingJobPostController::class, 'updateJobNcs'])->name('updateForm-Ncs');

    // Route::post('/submit-form',[NcsJobDispatchController::class, 'submitForm'])->name('submitForm');
    ...
    // Report
    Route::get('/report/total-registration', [ReportController::class, 'getReport'])->name('admin.report.total.registration');
    ...
    // adding.....
    Route::get('/admin-controls/registering-authoritySoftDelete', [AdminController::class, 'SoftDelete'])->name('admin.controls.authoritySoft');
    Route::get('/admin-controls/registering-authorityRestore', [AdminController::class, 'registeringAuthority'])->name('admin.controls.authority');
    ...
    Route::get('/admin-controls/statement', [AdminController::class, 'paymentStatement'])->name('admin.controls.statement');
...
Route::post('/admin/submit-form', [NCSStagingJobPostController::class, 'handle'])->name('submitForm');

// Route::get('/employee-news-Ncs', [NCSStagingJobPostController::class, 'getJobsPostNcs'])->name('jobsPostNcs');
// Route::get('/employee-news/create-news-ncs', [NCSStagingJobPostController::class, 'createJobsPostNcs'])->name('create.jobs.post.Ncs');
